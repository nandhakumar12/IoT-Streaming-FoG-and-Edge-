...
export const SENSOR_CONFIG = {
  temperature:      { label: 'Temperature',   icon: '🌡️',  unit: '°C',  color: '#ef4444', chartColor: '#f87171' },
  vibration:        { label: 'Vibration',     icon: '📳',  unit: 'g',   color: '#f59e0b', chartColor: '#fbbf24' },
  humidity:         { label: 'Humidity',      icon: '💧',  unit: '%RH', color: '#3b82f6', chartColor: '#60a5fa' },
  pressure:         { label: 'Pressure',      icon: '🔵',  unit: 'hPa', color: '#8b5cf6', chartColor: '#a78bfa' },
  power_consumption:{ label: 'Power',         icon: '⚡',  unit: 'W',   color: '#22d3ee', chartColor: '#67e8f9' },
};
